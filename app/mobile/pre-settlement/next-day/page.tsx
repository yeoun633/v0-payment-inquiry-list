...
import { ArrowLeft, AlertCircle, Calendar, Wallet, CheckCircle2, UtensilsCrossed, ChevronDown, ChevronUp } from "lucide-react"
...
export default function NextDayPreSettlementPage() {
  ...
  const paymentDate = "2025-03-25 (화)"
  const paymentTime = "오전 10:00 ~ 11:00"
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="p-4 flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
          ...
          <h2 className="text-xl font-bold text-foreground mb-2">익일 선정산 신청 완료</h2>
          <p className="text-muted-foreground text-center mb-6">
            {summary.count}건에 대한 선정산 신청이 완료되었습니다.<br />
            {paymentDate} {paymentTime}에 입금될 예정입니다.
          </p>
          ...
          <Card className="w-full mb-6">
            <CardContent className="p-4 space-y-3">
              ...
              <div className="border-t pt-3 flex justify-between">
                <span className="font-medium">실수령 예정액</span>
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-10 bg-primary text-primary-foreground">
        <div className="flex items-center h-14 px-4">
          ...
          <h1 className="flex-1 text-center text-lg font-semibold pr-7">익일 선정산</h1>
        </div>
      </header>

      <div className="p-4 space-y-4">
        {/* Application Summary */}
        <Card className="bg-info text-info-foreground border-0">
          <CardContent className="p-5">
            <div className="flex justify-between items-start mb-2">
              <p className="text-sm text-info-foreground/80">신청 대상</p>
            ...
            <p className="text-xs text-info-foreground/60 mt-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">익일 선정산 가능 금액</span>
              <span className="font-medium">{summary.totalSettlement.toLocaleString()}원</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">예상 수수료 (1.5%)</span>
              <span className="text-destructive">-{summary.estimatedFee.toLocaleString()}원</span>
            </div>
            <div className="border-t pt-3 flex justify-between">
              <span className="font-medium">실수령 예정 금액</span>
        ...
        <Card>
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-muted-foreground">{paymentTime}</p>
          </CardContent>
        </Card>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <ul className="text-xs text-warning-foreground/80 space-y-1">
                  ...
                  <li>• 수수료는 실시간 선정산 대비 낮습니다. (1.5%)</li>
                  <li>• 지급은 다음 영업일 오전에 처리됩니다.</li>
                </ul>
              </div>
            </div>
          </CardContent>
