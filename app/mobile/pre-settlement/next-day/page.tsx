...
import { ArrowLeft, AlertCircle, Calendar, Wallet, CheckCircle2 } from "lucide-react"
      ...
      <div className="p-4 space-y-4">
        ...
        <Card className="bg-info text-info-foreground border-0">
          <CardContent className="p-4">
            <p className="text-sm text-info-foreground/80 mb-1">익일 선정산 가능 금액</p>
